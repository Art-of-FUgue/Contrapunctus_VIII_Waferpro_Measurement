...
write_tmp += 'Page (name={}'.format(indicator)+ 'x=time, y1=iA, y2=iC, y3=vA, y4=vB,y5=vC) {T=%s}\n' %(temp)
setup_name = dut_name + '/stress'
write_tmp = genMEA1(write_tmp, setup_name,'time', 'iA', 'iC', 'vA', 'vB','vC')
...
fileName = get_var('../runPolyaging/filename')+'stress_time={}'.format(stresstime)+'.mea'
