...
iccap_func("../stress_ACJ", "Clear Data/Both")
...
for i in range(0, len(Stress_Time_Values)):
    ...
    iccap_func("../stress_ACJ/time", "STFV", ["Stop", stresstime])
    iccap_func("../stress_ACJ/time", "STFV", ["Step Size", timestep])
    iccap_func("../stress_ACJ/time", "Redisplay")
    ...
    iccap_func("../stress_ACJ/connect_stress", "Execute")
    iccap_func("../stress_ACJ", "Measure")
    iccap_func("../stress_ACJ/export_stress", "Execute")
    iccap_func("../stress_ACJ/disconnect", "Execute")
    iccap_func("../stress_ACJ", "Close All")
